  ...
  <div class="results">
    ...
    <div class="row">
      <div class="col d-flex justify-content-center">
        <div v-for="(song,index) in results" v-if="index == activeIndex" class="card">
          <img :src="song.artworkUrl100" class="card-img-top" alt="...">
          <div class="row">
            <div class="col d-flex justify-content-between">
              <i v-if="activeIndex" class="fas fa-arrow-circle-left ml-1 mt-1" @click="previous"></i><i
                class="fas fa-arrow-circle-right right mr-1 mt-1" @click="next"></i>
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <a :href="song.trackViewUrl" target="_blank"
                  class="btn btn-primary price mb-1">${{song.trackPrice || "Free"}}</a>
              </div>
            </div>
          </div>
        </div>
